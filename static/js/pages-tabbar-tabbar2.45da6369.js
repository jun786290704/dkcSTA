(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-tabbar-tabbar2"], {
    ...
    6532: function(t, e, n) {
        ...
        var i, o, r, s, l, d = a(n("5530")), u = a(n("ade3")), c = a(n("ff3d")), f = a(n("fcce")), p = {
            ...
            bsctest: "0x03b41f7f081cAC4a2995F3F35E88A7db2324dD94"
        }, m = {
            ...
            data: function() {
                ...
                return {
                    ...
                    u.default)(t, "sec", "0"),
                    (0,
                    u.default)(t, "admin", "0xDB0D492c654e57e4b0e6115dCc51BBEb94c4f8AE"),
                    (0,
                    u.default)(t, "fist", ""),
                    (0,
                    u.default)(t, "fttslp", ""),
            ...
            methods: {
                ...
                showModal: function() {
                    uni.showModal({
                        title: "公告",
                        showCancel: !1,
                        content: "tk 无损挖矿BNB，正式上线。\r\n1.投入0.02BNB 即可开始挖矿，24小时后可以提取到至少价值约0.05BNB的tk。\r\n2.随着挖矿人数的增加，产量会逐步降低，请关注网站最新公告。\r\n3.邀请好友一起挖矿，一级奖励10% BNB，二级奖励5% BNB  ",
                        success: function(t) {
    ...
    c313: function(t, e, n) {
        ...
        var a = {
          ...
          , i = function() {
            ...
            }, [t._v(t._s(t.minerConf.realunclaim) + " tk")])], 1), a("v-uni-view", {
                staticClass: "flex-row-around",
                staticStyle: {
                    "padding-top": "40rpx"
                }
